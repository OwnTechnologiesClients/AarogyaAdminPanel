    ...
    <Layout>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-gray-600">Manage patients and their records</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="p-6">
            <div className="space-y-4">
              {[
                { name: "John Smith", age: 35, condition: "Hypertension", status: "Active", avatar: "JS" },
                { name: "Maria Garcia", age: 28, condition: "Diabetes", status: "Active", avatar: "MG" },
                { name: "David Lee", age: 42, condition: "Asthma", status: "Recovered", avatar: "DL" },
                { name: "Sarah Wilson", age: 31, condition: "Migraine", status: "Active", avatar: "SW" },
              ].map((patient, index) => (
